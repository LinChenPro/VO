...
import static visionaudio.U.AT;
import static visionaudio.U.C;
import static visionaudio.U.S;
import static visionaudio.U.T;
import static visionaudio.U.ac;
...
import static visionaudio.V.mXY;
import static visionaudio.V.mult;
import static visionaudio.V.multD;
import static visionaudio.V.sub;
...
//				new InputPoint(4, -4, 8d/deep),
		...
		AudioFormat format = new AudioFormat(wfm.getSimpleRate(), wfm.frameSize, 2, true, true);
